...
📌 **Notas generales:**
- Todos los identificadores primarios deben ser únicos.
- Se recomienda uso de claves foráneas para integridad referencial.
- Los campos de tipo fecha deben cumplir con el formato estándar ISO `YYYY-MM-DD`.
- Se recomienda validar atributos como estados y tipos mediante catálogos de valores controlados.
