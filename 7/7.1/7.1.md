...
CREATE TABLE Condicion_despacho (
    ...
    es_critica BOOLEAN DEFAULT false -- Si es true, no se puede proceder con el despacho
);
...
CREATE TABLE Rechazo_Despacho (
    ...
    estado estado_accion_enum NOT NULL DEFAULT 'pendiente'
);
...
CREATE TABLE Solucion_Reclamo (
    ...
    motivo_rechazo VARCHAR(200),
    observaciones VARCHAR(200),
    es_solucion_final BOOLEAN DEFAULT false
);
