...
CREATE TABLE Usuario (
    cod_usuario UUID DEFAULT gen_random_uuid() PRIMARY KEY,  -- Clave primaria
...
CREATE TABLE ordenes_entrega (
    cod_orden UUID DEFAULT gen_random_uuid() PRIMARY KEY,  -- Clave primaria
    destino VARCHAR(255) NOT NULL,
    origen VARCHAR(255) NOT NULL,
    fecha_orden DATE NOT NULL,
    hora_orden TIME NOT NULL,
    descripcion TEXT NOT NULL,
    cod_cliente UUID,  -- Clave foránea a Cliente
    cod_prioridad UUID,  -- Clave foránea a Prioridad
    fecha_creacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (cod_cliente) REFERENCES Cliente(cod_cliente),
    FOREIGN KEY (cod_prioridad) REFERENCES Prioridad(cod_prioridad)
);


CREATE TABLE Producto (
    cod_prod UUID DEFAULT gen_random_uuid() PRIMARY KEY,  -- Clave primaria
    ...
    cod_tipo_prod UUID,  -- Clave foránea a Tipo_producto
    fecha_creacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (cod_tipo_prod) REFERENCES Tipo_producto(cod_tipo_prod)
);


CREATE TABLE Prioridad (
    cod_prioridad UUID DEFAULT gen_random_uuid() PRIMARY KEY,  -- Clave primaria
    descripcion TEXT NOT NULL,
...
CREATE TABLE Tipo_producto (
    cod_tipo_prod UUID DEFAULT gen_random_uuid() PRIMARY KEY,  -- Clave primaria
    descripcion TEXT NOT NULL,
    fecha_creacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
--permite:Usuario y una orden de entrega (ordenes_entrega). Un Usuario puede estar relacionado con varias órdenes de entrega y viceversa. 
CREATE TABLE Permite (
    cod_usuario UUID,  -- Clave foránea a Usuario
    cod_orden UUID,  -- Clave foránea a Ordenes_entrega
    PRIMARY KEY (cod_usuario, cod_orden),
    fecha_creacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (cod_usuario) REFERENCES Usuario(cod_usuario),
    FOREIGN KEY (cod_orden) REFERENCES ordenes_entrega(cod_orden)
);
---Contine:Producto y una orden de entrega (ordenes_entrega). Cada orden de entrega puede contener varios Productos, y cada Producto puede estar presente en varias ordenes_entrega. 
CREATE TABLE Contiene (
    cod_prod UUID,  -- Clave foránea a Producto
    cod_orden UUID,  -- Clave foránea a Ordenes_entrega
    PRIMARY KEY (cod_prod, cod_orden),
    fecha_creacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
