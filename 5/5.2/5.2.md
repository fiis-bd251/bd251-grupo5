...
| Campo            | Tipo de Dato       | Descripción                              |
|------------------|--------------------|------------------------------------------|
| id_carga         | SERIAL PRIMARY KEY | Identificador de la carga                |
| fecha_carga      | DATE               | Fecha en que se despacha                 |
| hora_carga       | TIME               | Hora en que se despacha                  |
| estado_carga     | INT                | FK a `estado_carga`                      |
| Sku              | INT                | FK a `Sku`                               |
| temperatura      | NUMERIC(5,2)       | Temperatura en °C                        |
| canal_de_atención| INT                | FK a `canal_de_atención`                 |
| hub              | INT                | FK a `hub`                               |
|tipo_producto     | INT                | FK a `tipo_producto`                     |            
...
| Campo               | Tipo de Dato       | Descripción                                             |
|---------------------|--------------------|---------------------------------------------------------|
| id_calidad          | SERIAL PRIMARY KEY | Identificador de la verificación de calidad del vehiculo|
...
| temperatura_vehiculo| NUMERIC(5,2)       | Temperatura en °C                                       |
