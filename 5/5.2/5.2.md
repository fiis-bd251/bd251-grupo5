...
| id_incidencia    | VARCHAR(20)            | Se obtiene del módulo de Reclamos si se genera incidencia             |

Ejemplo de firma_cliente y foto_evidencia en un envío de incidencia al módulo de Reclamos en formato JSON:

    {
      "evento_type": "incidencia_registrada",
