...
## CU01 – Gestionar pesaje de SKUs para habilitar generación de pedidos
- **Verificar pesajes completados**
- **Habilitar generación de pedidos**

Resultado esperado:
Todos los SKUs de un pedido han sido pesados correctamente, y el sistema habilita la opción de generar dicho pedido para continuar con su preparación y carga.

## CU02 – Preparar y asignar pedidos a unidades de transporte
...
## CU03 – Realizar control de calidad y aprobar unidad para despacho
...
## CU04 – Despachar unidad de transporte con documentación completa
