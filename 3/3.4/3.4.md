...
|------------------------------------|------------------------------------------------------------|
| **Planificador logístico**         | - Crear y editar rutas de despacho                         |
|                                    | - Asignar vehículos por tipo de carga                      |
|                                    | - Asignar pedidos a rutas y ventanas horarias              |
| **Operador de carga**              | - Registrar SKU pesados                                    |
|                                    | - Confirmar preparación                                    |
|                                    | - Generar guías de despacho                                |
| **Inspector de calidad**           | - Verificar seteo de temperatura                           |
|                                    | - Aprobar carga y emitir visto bueno                       |
|                                    | - Registrar datos de calibración                           |
| **Chofer**                         | - Descargar orden de despacho                              |
|                                    | - Visualizar puntos de entrega                             |
|                                    | - Confirmar entregas y registrar incidencias               |
| **Supervisor logístico / Gerente** | - Visualizar dashboard de entregas                         |
|                                    | - Analizar cumplimiento vs. tiempos                        |
|                                    | - Revisar ratios de eficiencia                             |
...
# 🎛️ Menú de Opciones del Sistema - Perfil: Operador Logístico
...
### 🟩 Caso de Uso 3: Revisar ruta de despacho
**Actor**: Coordinador de distribución

**Precondición**: Unidad precintada, documentación disponible.

**Flujo principal**:
1. Selecciona unidad disponible.
2. Revisa asignación de ruta
3. Lista de destinos de las cargas (12-17 puntos para carnes, 25-35 para huevo).
4. Se asigna ventana horaria por punto (según cliente).

**Postcondición**: Unidad despachada con control de ruta y validación activa.


### 🟩 Caso de Uso 4: Confirmar Entrega por Punto
**Actor**: Repartidor o personal de recepción

**Precondición**: Ruta en curso.

**Flujo principal**:
1. Se escanea punto de entrega.
2. El sistema solicita confirmaciones específicas por canal:
   - Autoservicio: temperatura + tiempo de descarga.
   - Institución: carga de documentos firmados.
   - Foodservice: validación rápida.
3. Se genera firma electrónica o registro fotográfico.

**Postcondición**: Punto entregado y registrado con evidencia.
