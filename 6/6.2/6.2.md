...
| Tamaño de extent inicial         | 64 KB (8 bloques)    | Para lecturas secuenciales y crecimiento progresivo        |
...
| id_asignacion         | UUID                 | 16             | Clave foránea                      |
| ubicacion_actual      | POINT                | 16             | Coordenadas geográficas            |
...
| timestamp_registro    | TIMESTAMPTZ          | 8              | Fecha y hora de la medición        |
...
- Bloques necesarios para 5000 registros = 5000 / 51 ≈ **99 bloques**
- Tamaño total = 99 * 8192 = **811,008 bytes ≈ 0.77 MB**
...
| **Total estimado** | -                    | **442 bytes**  | Tamaño total aproximado por fila           |

#### Tamaño Total - Fórmulas

- Espacio útil por bloque = (8192 - 24) * 0.9 = **7340.4 bytes**
- Filas por bloque = 7340.4 / 442 = **17 filas**
- Bloques necesarios para 2500 registros = 2500 / 17 ≈ **147 bloques**
- Tamaño total = 147 * 8192 = **1,204,224 bytes ≈ 1.15 MB**
